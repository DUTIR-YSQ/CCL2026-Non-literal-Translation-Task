...
#### 子任务1
| 模型结果 | 命中 | 命中率 | avg_gold_sim | avg_silver_sim | avg_margin |
|---|---:|---:|---:|---:|---:|
| Qwen2-7B zero1 | 37 | 29.84% | 0.3809 | 0.4777 | -0.0968 |
| Qwen2-7B 微调1 | 57 | 45.97% | 0.3282 | 0.3070 | 0.0211 |

#### 子任务2
| 模型结果 | 正确 | 准确率 |
|---|---:|---:|
| Qwen2-7B zero2 | 33 | 26.61% |
| Qwen2-7B 微调2 | 45 | 36.29% |
